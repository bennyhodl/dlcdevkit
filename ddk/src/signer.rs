...
pub trait DeriveSigner {
    ...
    fn store_derived_key_id(&self, index: u32, key_id: [u8;32], secret_key: SecretKey, public_key: PublicKey);
...
impl DeriveSigner for SimpleDeriveSigner {
    ...
    fn store_derived_key_id(&self, _index: u32, _key_id: [u8;32], _secret_key: SecretKey, _public_key: PublicKey) {}        
